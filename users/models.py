...
class User(AbstractUser):
    ...
    city = models.CharField(max_length=100, null=True, blank=True, verbose_name='Город пользователя')
    avatar = models.ImageField(upload_to='users/avatars', blank=True, null=True, verbose_name='Аватар пользователя')
    tg_id = models.CharField(max_length=100, verbose_name='Telegram ID пользователя', unique=True)
